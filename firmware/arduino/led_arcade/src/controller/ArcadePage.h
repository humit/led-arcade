...
function drawStack(cv){const c=prep(cv),colors=STACK_PREVIEW_COLORS;[[6,18,0],[10,18,0],[14,18,1],[18,18,1],[10,14,2],[14,14,2],[18,14,2],[14,10,3],[18,10,3],[22,10,3],[22,6,4],[26,6,4],[26,10,4]].forEach(([x,y,color])=>px(c,x,y,4,4,colors[color]));for(let y=3;y<22;y+=4)px(c,48,y,10,1,'#29314a')}
